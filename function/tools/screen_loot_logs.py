...
def screen_loot_logs(handle, zoom, save_log_path, stage_id, player):
    # 记录战利品
    img = []
    ...
    img.append(capture_picture_png(handle=handle, raw_range=[209, 502, 698, 551]))  # X_min,Y_min,X_max,Y_max
