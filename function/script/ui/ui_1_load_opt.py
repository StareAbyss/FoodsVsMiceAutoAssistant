...
class MyMainWindow1(MyMainWindow0):
    ...
    def opt_to_ui(self):
        ...
        self.ReloadAndDailyTask_Active.setChecked(self.opt["reload_and_daily_tasks"]["active"])
        
        self.GuildTask_Active.setChecked(self.opt["guild_task"]["active"])
        self.GuildTask_Stage.setChecked(self.opt["guild_task"]["stage"])
        self.GuildTask_Deck.setValue(self.opt["guild_task"]["deck"])
        self.GuildTask_1P.addItems(battle_plan_list)
        self.GuildTask_2P.addItems(battle_plan_list)
        self.GuildTask_1P.setCurrentIndex(self.opt["guild_task"]["battle_plan_1p"])
        self.GuildTask_2P.setCurrentIndex(self.opt["guild_task"]["battle_plan_2p"])

        self.SpouseTask_Active.setChecked(self.opt["spouse_task"]["active"])
        self.SpouseTask_Deck.setValue(self.opt["spouse_task"]["deck"])
        self.SpouseTask_1P.addItems(battle_plan_list)
        self.SpouseTask_2P.addItems(battle_plan_list)
        self.SpouseTask_1P.setCurrentIndex(self.opt["spouse_task"]["battle_plan_1p"])
        self.SpouseTask_2P.setCurrentIndex(self.opt["spouse_task"]["battle_plan_2p"])
    ...
    def ui_to_opt(self):
        ...
        self.opt["reload_and_daily_tasks"]["active"] = self.ReloadAndDailyTask_Active.isChecked()
        
        self.opt["guild_task"]["active"] = self.GuildTask_Active.isChecked()
        self.opt["guild_task"]["stage"] = self.GuildTask_Stage.isChecked()
        self.opt["guild_task"]["deck"] = self.GuildTask_Deck.value()
        my_transformer(self.GuildTask_1P, "guild_task", "battle_plan_1p")
        my_transformer(self.GuildTask_2P, "guild_task", "battle_plan_2p")

        self.opt["spouse_task"]["active"] = self.SpouseTask_Active.isChecked()
        self.opt["spouse_task"]["deck"] = self.SpouseTask_Deck.value()
        my_transformer(self.SpouseTask_1P, "spouse_task", "battle_plan_1p")
        my_transformer(self.SpouseTask_2P, "spouse_task", "battle_plan_2p")
