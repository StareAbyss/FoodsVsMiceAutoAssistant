...
如果您在360游戏大厅的小号列表中输入了您的账号和密码, 它将开启自动登录模式.
对于4399用户, 该模式下的登陆, 有概率弹出验证码, 或产生错误的界面跳转, 这将导致登录失败. 为了避免该问题, 建议您清空360游戏大厅注册的小号的账号密码, 采用手动输入+勾选4399自动登录选项, 以完成稳定的登录.
对于QQ相关渠道用户, 也推荐清空360游戏大厅注册的小号的账号密码, 以避免360游戏大厅无效的账号密码输入尝试.
