...
[反馈交流群]: QQ - 786921130
[爱发电赞助](https://afdian.net/a/zssy_faa)
...
**深度使用, 可认真通读下文, 部分存在于轻度pdf的文档的部分可能不再赘述**

## 平台支持

* 目前仅支持 **<Windows7及以上>** **<360游戏大厅>** **<多窗口模式>**
* 4399渠道服(v0.9.1+)和QQ游戏大厅渠道服(v1.0.7+)可以稳定使用
* QQ空间渠道需在文件中的 [resource/picture/common/用户自截] 中修改空间服登录界面截图, 需在快捷登录界面分别截图1P和2P上半部分QQ头像, 100%缩放倍率, png格式, 位深32
...
* 跨服作战前, 由1P邀请2P
  * 原因是, 一般默认1P练度高方便创建房间
  * 需要自行更改 resource/picture/common/用户自截/cross_server_1P.png 的图片以进行邀请, 100%缩放倍率, png格式, 位深32

## 软件中重要信息的填写

* 窗口名和游戏名称
    * **<填写错误 低版本(v0.9.1-)会直接导致软件闪退, 高版本(v1.0.0+)会直接弹窗提醒不启动>**
